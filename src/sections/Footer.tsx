...
const Footer = (props: { lng: string }) => {
  let { setSelectedLink, setSubLink } = useContext(ActiveLinkContext);
      ...
      <div className='flex flex-col justify-between gap-16 lg:flex-row'>
        ...
        <MotionComponent initial='hide' animate='visible' variants={opacityAnimVariants()} className='flex flex-col space-y-[16px] '>
          <div className='flex items-center gap-[18px]'>
            ...
            <div>
              <div className='text-p22 font-normal'>DevRiser</div>
              <div className='max-w-md text-p15 opacity-70'>Elevating Your Project</div>
            </div>
          </div>
        </MotionComponent>
        ...
        <MotionComponent
          ...
          <ul className='flex flex-col gap-2.5 '>
            <li
              ...
              className={cn(
                "text-p15 brightness-[1.4] max-lg:cursor-pointer",
