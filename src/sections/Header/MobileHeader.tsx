...
import FramerProps, { opacityAnimVariants, slideVerticallyVariants } from "@/utils/FramerVariants";
  ...
  return (
    <>
      ...
      <AnimatePresence mode='wait'>
        ...
        {mobileMenuOpened && (
          <m.div
            {...FramerProps(slideVerticallyVariants("-120%", 0))}
          ...
          >
            ...
            <ul className=' mx-auto flex h-fit w-full grow flex-col gap-[26px] bg-white  p-6 pt-8  text-navlink  dark:bg-gray-30 [&_p]:text-basic [&_p]:font-normal'>
              ...
              <li className='flex flex-col gap-2 '>
                <m.button
                  {...FramerProps(opacityAnimVariants(0.15, 1))}
                      ...
                      {LANGUAGES.map((lang, index) => (
                        ...
                        >
                          <Link
                            ...
                            className={cn("flex h-full w-full items-center justify-start gap-4 px-6 py-3  text-p12")}
                          >
