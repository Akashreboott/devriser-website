			...
			<AnimatePresence>
				{services && (
					<motion.nav
						...
						className='fixed top-0 z-50 flex w-full items-center justify-center gap-20 bg-white/[0.05]  py-5 backdrop-blur-2xl max-lg:hidden '>
						<div className='flex  justify-center gap-5'>
							{NAV_LINKS["services"].map(([name, path]) => (
								<Link key={name} className='relative inline-block' href={path}>
									{name}
									{services === name && (
										<MotionComponent
											as='span'
